import comparadorTipos from './comparacionTipos.js'
import { fethData } from './index.js'
...
export default function (){
    ...
    if (data.types[0].type.name == 'water') {
        console.log(`Soy un pokemon de tipo ${data.types[0].type.name == 'water'}`)
    ...
    if (data.types[1] != null && data.types[1] != null && data.types[1].type.name == 'rock') {
